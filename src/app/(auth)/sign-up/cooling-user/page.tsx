...
export default function SignUpCoolingUserPage() {
  ...
  return (
    <Card className="shadow-xl border-0">
      <CardHeader>
        <CardTitle className="text-xl">Create Farmer Account</CardTitle>
        <CardDescription>Store your produce and access cold storage</CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="coolingUnitId">Cooling Unit ID (optional)</Label>
            <Input
              id="coolingUnitId"
              type="number"
